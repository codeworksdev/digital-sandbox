(function()
{
    var CACHE = {
        ...
        LIST : [
            ...
            'frontend/img/web/devices/apple/ipad.png',
            'frontend/img/web/devices/apple/ipad_air.png',
            'frontend/img/web/devices/apple/ipad_air-l.png',
            'frontend/img/web/devices/apple/ipad_mini.png',
            'frontend/img/web/devices/apple/ipad_mini-l.png',
            'frontend/img/web/devices/apple/ipad_pro_12_9.png',
            'frontend/img/web/devices/apple/ipad_pro_12_9-l.png',
            'frontend/img/web/devices/apple/ipad_pro_9_7.png',
            'frontend/img/web/devices/apple/ipad_pro_9_7-l.png',
            'frontend/img/web/devices/apple/ipad-l.png',
            'frontend/img/web/devices/apple/iphone_5s.png',
            'frontend/img/web/devices/apple/iphone_5s-l.png',
            'frontend/img/web/devices/apple/iphone_6plus.png',
            'frontend/img/web/devices/apple/iphone_6plus-l.png',
            'frontend/img/web/devices/google/nexus_10.png',
            'frontend/img/web/devices/google/nexus_10-l.png',
            'frontend/img/web/devices/google/nexus_7.png',
            'frontend/img/web/devices/google/nexus_7-l.png',
            'frontend/img/web/devices/samsung/galaxy_s5.png',
            'frontend/img/web/devices/samsung/galaxy_s5-l.png',
            'frontend/img/web/tile.png',
            ...
            'frontend/themes/default/css/print.css',
            'frontend/themes/default/css/style.css',
            'frontend/themes/default/onload.js',
            'index.html',
